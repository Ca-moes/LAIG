...
- Strong Points
  - We decided to make an exterior scene, apart from our TP1 Scene.
  - Our internal scene is based on a real place;
  ...
  - We have implemented a FPS Counter, and it is displayed on the web app;
  - We have implemented the blend effect to have a better view of the sprite animations.
- Scene;
...
- Illumination could be better represented.
