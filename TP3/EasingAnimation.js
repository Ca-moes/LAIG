        ...
        if ((t - this.startTime) >= this.heightLevels[this.heightLevels.length - 1].instant) {
            ...
            for (let i = 0; i < this.heightLevels.length; i++) {
                ...
                // entre o primeiro keyframe e o ultimo
                    ...
                    this.y = (this.heightLevels[i - 1].height + this.finalPosition[1] - this.initialPosition[1]) + yAnimationFactor * (this.heightLevels[i].height - this.heightLevels[i - 1].height)
                    break
                }
            }
        }
